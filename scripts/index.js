...
async function main() {
  ...
  await token.setStrategy(['500000', '500000'], [DAI_ADDRESS, WBTC_ADDRESS]);
  ...
  //   try {
  //     console.log(parseInt(element.args[0]._hex, 16));
  //   } catch {}
  // });
  ...
  // tokenBalance = parseInt(await token.balanceOf(owner.address), 16);
  // console.log('yfi balance', tokenBalance);
  // console.log(`owner ETH: ${await owner.getBalance()}`);
}
main()
